...
func (a *OpenTracingAppLayer) CountChannelPostsUA(channelId string, after int64) (*model.PostCount, *model.AppError) {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.CountChannelPostsUA")
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.CountChannelPostsUA(channelId, after)
...
func (a *OpenTracingAppLayer) GetChannelPostsUA(channelId string, after int64, before int64, desc bool, page int, perPage int) (*model.PostList, *model.AppError) {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.GetChannelPostsUA")
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetChannelPostsUA(channelId, after, before, desc, page, perPage)
...
func (a *OpenTracingAppLayer) GetUserByNicknameUA(username string) (*model.User, *model.AppError) {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.GetUserByNicknameUA")
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetUserByNicknameUA(username)
